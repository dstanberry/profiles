...
# WSL Interpop
################################################################################
Import-WslCommand "awk", "bat", "colordiff", "cp", "curl", "cut", "diff", "diff-highlight", "emacs", "exa", "git", "grep", "head", "less", "lnav", "ls", "man", "mv", "nano", "nvim", "rm", "sed", "seq", "sh", "tail", "tmux", "tree", "which", "xargs"

$WslDefaultParameterValues = @{ }
$WslDefaultParameterValues["exa"] = "--ignore-glob='ntuser\.*' --ignore-glob='NTUSER\.*' --all --group-directories-first"
...
$WslEnvironmentVariables["EDITOR"] = "/usr/bin/nvim"
$WslEnvironmentVariables["HISTCONTROL"] = "erasedups:ignoreboth"
$WslEnvironmentVariables["LANG"] = "en_US.utf8"
$WslEnvironmentVariables["LESS"] = "-iFMRX"
$WslEnvironmentVariables["LESSCOLOR"] = "always"
...
$WslEnvironmentVariables["PAGER"] = "/usr/bin/less"
$WslEnvironmentVariables["PWD"] = "/mnt/d"
$WslEnvironmentVariables["SHELL"] = "/bin/zsh"
